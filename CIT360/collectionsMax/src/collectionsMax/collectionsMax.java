...
public class collectionsMax {
    ...
    public static void main(String a[]){
        ...
        emps.add(new Empy(1, "Peyton", 5000));
        emps.add(new Empy(120, "Kendra", 25000));
        emps.add(new Empy(17, "Jared", 74000));
        emps.add(new Empy(150, "Tanya", 24000));
        Empy maxSal = Collections.max(emps, new EmpyComp());
        System.out.println("Person with max salary: "+maxSal);
    }
}
